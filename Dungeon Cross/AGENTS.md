...
This repository contains a Unity 2D prototype for **Dungeon Cross**:
a Frogger-style dungeon game where a knight crosses trap-filled corridors using swipe controls.

Primary goal:
- quickly build a playable prototype with core crossing mechanic
